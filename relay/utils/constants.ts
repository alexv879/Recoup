...
export const SUBSCRIPTION_TIERS = {
  ...
  STARTER: 'starter',  // ✨ NEW - £12 founding / £24 standard
  PRO: 'pro',          // ✨ NEW - £22 founding / £45 standard (Most Popular)
  BUSINESS: 'business' // ✨ NEW - £75 founding / £150 standard
} as const;
...
export const TIER_LEVELS = {
  ...
  business: 3,
  // Legacy support
  paid: 2, // Map old 'paid' to 'pro' level
} as const;
...
export const COLLECTIONS_LIMITS = {
  ...
  pro: 25,           // 75th percentile: 12-15 invoices/month
  business: Infinity, // 90th percentile: 20+ invoices/month (unlimited)
  // Legacy support
  paid: 25,          // Old 'paid' tier gets pro limits
} as const;
...
export const FOUNDING_MEMBER_PRICING = {
  ...
  pro: 22,       // £22/month (vs £45 standard)
  business: 75,  // £75/month (vs £150 standard)
} as const;
