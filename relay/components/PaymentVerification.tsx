...
import { AccessibleDialog, AccessibleButton } from '@/lib/accessibility';
...
export function PaymentVerificationModal({
  ...
  const handleConfirm = () => {
    trackEvent('payment_verification_confirmed', {
      claimId: claim.id,
  ...
  const handleRequestEvidence = () => {
    trackEvent('payment_verification_evidence_requested', {
      claimId: claim.id,
      invoiceId: claim.invoiceId,
    });
    onRequestEvidence();
  ...
  const handleReject = () => {
    ...
    trackEvent('payment_verification_rejected', {
      claimId: claim.id,
      invoiceId: claim.invoiceId,
      reason: rejectReason,
    });
                ...
                <h3 className="font-semibold text-gray-900 mb-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      onClick={() => trackEvent('evidence_downloaded', { claimId: claim.id })}
                    >
                    ...
                    {!claim.evidenceFileName?.endsWith('.pdf') && (
                      <button
                        onClick={() => {
                          setShowFullscreenEvidence(true);
                          trackEvent('evidence_fullscreen_opened', { claimId: claim.id });
                        }}
