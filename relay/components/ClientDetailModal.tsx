...
const ClientDetailModal: React.FC<ClientDetailModalProps> = ({ client, onClose, onArchive, onUnarchive }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40" role="dialog" aria-modal="true" aria-labelledby="client-modal-title">
