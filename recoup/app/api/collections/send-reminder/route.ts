...
export async function POST(request: NextRequest) {
    try {
        ...
        logInfo('Manual reminder send requested', {
            userId,
        ...
        await trackServerEvent('email_sent', {
            ...
            reminder_level: body.level,
            recipient_email: result.recipientEmail || 'unknown',
            amount: result.invoiceAmount || 0,
            manual_trigger: true,
        ...
        logError('Manual reminder send failed', {
