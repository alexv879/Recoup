...
interface DashboardSegmentFiltersProps {
    clients: string[];
    paymentMethods: string[];
    onChange: (filters: { clients: string[]; status: string[]; paymentMethods: string[] }) => void;
}

export function DashboardSegmentFilters({ clients, paymentMethods, onChange }: DashboardSegmentFiltersProps) {
