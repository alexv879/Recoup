/**
 * DEPRECATED - Python migration available
 * Use `python3 scripts/migrate_stripe_plans.py --dry-run` or `--execute`
 * The Node/TS migration was replaced to centralize migration tooling in Python.
 */
...
// Export nothing — migration moved to scripts/migrate_stripe_plans.py
