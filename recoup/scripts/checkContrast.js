// This script was replaced by a Python equivalent. Use `python3 scripts/check_contrast.py` instead.
console.log('Deprecated: Use `python3 scripts/check_contrast.py`');
process.exit(0);
...
// Node version removed — run Python script
