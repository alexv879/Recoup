...
// NOTE: This is a stub; this job was migrated to a Python utility at
// `python-services/pricing_migration.py`. Keep this file as a placeholder during
// transition; call the python script from your infra or CI when ready.

import Stripe from 'stripe';
import { nanoid } from 'nanoid';

// NOTE: Stripe's TS types sometimes restrict apiVersion literals to a small set —
// cast options to any to avoid build-time type mismatch for migration scripts.
